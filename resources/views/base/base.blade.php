...
<div class="loading-screen">
    <svg class="paw-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" stroke="white" stroke-width="10" fill="none" stroke-dasharray="4500" animation="draw 8s ease">
        ...
        <h2 class="loading-text">PawCloud</h2>
        <h2 class="loading-text2">A global cloud platform for lost dogs, rescue, and adoption</h2>
    </div>
</div>
