<nav class="nav_bg">
    <div id="nav_fullscreenmobile" class="flex flex-wrap items-center justify-between mx-auto p-4 md:bg-transparent">
        <a class="flex items-center space-x-3 rtl:space-x-reverse ms-2 md:ms-5 lg:ms-5">
            <img src="{{ asset('assets/icons/supaw-logo.jpg') }}" class="w-10 md:w-16 lg:w-18 rounded-lg" alt="Flowbite Logo">
        ...
        <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse me-5">
            ...
            <button id="navbar-toggle" data-collapse-toggle="navbar-sticky" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-white rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-sticky" aria-expanded="false">
        ...
        <div class="items-center justify-between hidden w-full h-full bg-transparent lg:bg-transparent lg:flex lg:w-auto lg:order-1 transition-all duration-500 ease-in-out" id="navbar-sticky">
            <ul class="flex flex-col h-[100vh] lg:h-full justify-end p-4 lg:p-0 mt-4 font-medium lg:space-x-8 rtl:space-x-reverse lg:flex-row lg:mt-0 lg:border-0">
                <li>
                ...
                <li>
                    <a href="#shelter_list" class="nav_options">Shelter List</a>
                </li>
                @if (Auth::check())
                ...
                @elseif (Auth::Check() && Auth::user()->role === 'shelter_owner')
                <li>
                    <a href="{{route('shelter.dashboard')}}" class="nav_options">Shelter Owner Page</a>
                </li>
                @endif
            </ul>
        </div>
