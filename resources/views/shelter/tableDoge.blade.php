...
@section('judul')
    <h1 class="font-dmsans text-black dark:text-white text-lg md:text-2xl font-bold ps-8">My Shelter - Doge Table</h1>
...
@section('dataTable')
    <!-- reuse the admin table view layout but scoped to owner doges -->
    @if (session('success'))  
    <script>
